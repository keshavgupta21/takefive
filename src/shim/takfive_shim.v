...
// Instantiation of Axi Bus Interface S00_AXI
	takfive_shim_slave_lite_v1_0_S00_AXI # ( 
		.C_S_AXI_DATA_WIDTH(C_S00_AXI_DATA_WIDTH),
		.C_S_AXI_ADDR_WIDTH(C_S00_AXI_ADDR_WIDTH)
	) takfive_shim_slave_lite_v1_0_S00_AXI_inst (
...
// Instantiation of Axi Bus Interface M00_AXI
	takfive_shim_master_lite_v1_0_M00_AXI # ( 
		.C_M_START_DATA_VALUE(C_M00_AXI_START_DATA_VALUE),
		.C_M_TARGET_SLAVE_BASE_ADDR(C_M00_AXI_TARGET_SLAVE_BASE_ADDR),
		.C_M_AXI_ADDR_WIDTH(C_M00_AXI_ADDR_WIDTH),
		.C_M_AXI_DATA_WIDTH(C_M00_AXI_DATA_WIDTH),
		.C_M_TRANSACTIONS_NUM(C_M00_AXI_TRANSACTIONS_NUM)
	) takfive_shim_master_lite_v1_0_M00_AXI_inst (
...
// Instantiation of Axi Bus Interface M01_AXI
	takfive_shim_master_lite_v1_0_M01_AXI # ( 
	...
	) takfive_shim_master_lite_v1_0_M01_AXI_inst (
