...
module dram_mem #(
    ...
    logic [CL_WORDS-1:0][31:0] ram [0:DEPTH-1];
    ...
    wire [AWIDTH-1:0] idx      = dram_req.addr[LWIDTH+AWIDTH+1:LWIDTH+2];
    wire [AWIDTH-1:0] dbg_line = dbg_req.addr[LWIDTH+AWIDTH+1:LWIDTH+2];
    wire [LWIDTH-1:0] dbg_word = dbg_req.addr[LWIDTH+1:2];
    wire              accept   = dram_req.vld && !busy;
